...
#include "Nova/TestActor.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeTestActor() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	NOVA_API UClass* Z_Construct_UClass_ATestActor();
	NOVA_API UClass* Z_Construct_UClass_ATestActor_NoRegister();
...
// End Cross Module References
	...
	template<> NOVA_API UClass* StaticClass<ATestActor>()
	{
		return ATestActor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ATestActor);
	ATestActor::~ATestActor() {}
	struct Z_CompiledInDeferFile_FID_SKYWORLD_Source_Nova_TestActor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SKYWORLD_Source_Nova_TestActor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATestActor, ATestActor::StaticClass, TEXT("ATestActor"), &Z_Registration_Info_UClass_ATestActor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATestActor), 1296448034U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SKYWORLD_Source_Nova_TestActor_h_4170928428(TEXT("/Script/Nova"),
		Z_CompiledInDeferFile_FID_SKYWORLD_Source_Nova_TestActor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_SKYWORLD_Source_Nova_TestActor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
